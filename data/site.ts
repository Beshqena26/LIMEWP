...
export const SITE_TAB_COLOR_STYLES: Record<string, { bg: string; text: string; activeBg: string; activeText: string; ring: string }> = {
  ...
  orange: { bg: "bg-orange-500/10", text: "text-orange-400", activeBg: "bg-orange-500/15", activeText: "text-orange-400", ring: "ring-orange-500/20" },
  red: { bg: "bg-red-500/10", text: "text-red-400", activeBg: "bg-red-500/15", activeText: "text-red-400", ring: "ring-red-500/20" },
  purple: { bg: "bg-purple-500/10", text: "text-purple-400", activeBg: "bg-purple-500/15", activeText: "text-purple-400", ring: "ring-purple-500/20" },
};
