...
export const TOOL_CATEGORY_CONFIG: Record<string, { icon: string; count: number }> = {
...
export const TOOL_CATEGORY_ORDER = ["Server", "Security", "Development", "Database", "Performance", "Features", "Advanced"];
