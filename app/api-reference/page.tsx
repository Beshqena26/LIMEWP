    ...
    <AppShell>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${isLight ? "bg-slate-200 text-slate-600 ring-1 ring-slate-300" : "bg-slate-700 text-slate-300 ring-1 ring-slate-600"}`}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
            </svg>
          </div>
          <div>
            <h1 className={`text-2xl font-bold mb-1 ${isLight ? "text-slate-800" : "text-slate-100"}`}>API Reference</h1>
              ...
              <nav className="space-y-1">
                {navSections.map((section) => (
                  <div key={section.label} className="mb-4">
                    <div className={`text-[10px] uppercase font-semibold tracking-wider px-2 py-2 ${isLight ? "text-slate-500" : "text-slate-600"}`}>
                      {section.label}
                    </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className={`border-b ${isLight ? "border-slate-200" : "border-[var(--border-secondary)]"}`}>
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className={`text-lg font-semibold ${isLight ? "text-slate-800" : "text-slate-100"}`}>API Overview</h2>
                </div>
                <p className={`text-sm mb-5 leading-relaxed ${isLight ? "text-slate-600" : "text-slate-400"}`}>
            ...
            <div className={`border-b ${isLight ? "border-slate-200" : "border-[var(--border-secondary)]"}`}>
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className={`text-lg font-semibold ${isLight ? "text-slate-800" : "text-slate-100"}`}>Authentication</h2>
                </div>

                {/* Warning */}
                <div className={`rounded-xl p-4 mb-5 flex items-start gap-3 border ${isLight ? "bg-slate-100 border-slate-200" : "bg-slate-800/50 border-slate-700"}`}>
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} className={`w-5 h-5 flex-shrink-0 mt-0.5 ${isLight ? "text-slate-600" : "text-slate-400"}`}>
            ...
            <div className="p-6">
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className={`text-lg font-semibold ${isLight ? "text-slate-800" : "text-slate-100"}`}>Endpoints</h2>
              </div>
              ...
              <div className={`rounded-xl border overflow-hidden mb-4 ${isLight ? "bg-slate-50 border-slate-200" : "bg-[var(--gradient-card-to)] border-[var(--border-secondary)]"}`}>
                <div className={`px-5 py-4 border-b flex items-center gap-3 ${isLight ? "bg-slate-100 border-slate-200" : "bg-[var(--bg-primary)] border-[var(--border-secondary)]"}`}>
                  ...
                  <code className={`font-mono text-sm font-medium ${isLight ? "text-slate-800" : "text-slate-200"}`}>/sites</code>
                  <span className={`text-sm ml-2 ${isLight ? "text-slate-500" : "text-slate-500"}`}>List all sites in your account</span>
                </div>
                <div className="p-5">
                  {/* Parameters */}
                  <div className="mb-5">
                    <h4 className={`text-[11px] uppercase tracking-wider font-semibold mb-3 ${isLight ? "text-slate-500" : "text-slate-500"}`}>Query Parameters</h4>
                  ...
                  <div className="mb-5">
                    ...
                    <div className={`rounded-xl p-4 border overflow-x-auto ${isLight ? "bg-slate-900 border-slate-800" : "bg-[var(--bg-primary)] border-[var(--border-secondary)]"}`}>
                      <pre className="text-sm font-mono">
                        ...
                        <span className="text-slate-300">&quot;https://api.limewp.com/v1/sites&quot;</span>{" "}
                        <span className="text-slate-600">\</span>{"\n"}
                        {"  "}<span className="text-slate-400">-H</span>{" "}
                        <span className="text-slate-300">&quot;Authorization: Bearer lwp_sk_your_api_key&quot;</span>
                      </pre>
                    </div>
                  </div>
    ...
    "limit": 20
              ...
              <div className={`rounded-xl border overflow-hidden mb-4 ${isLight ? "bg-slate-50 border-slate-200" : "bg-[var(--gradient-card-to)] border-[var(--border-secondary)]"}`}>
                <div className={`px-5 py-4 border-b flex items-center gap-3 ${isLight ? "bg-slate-100 border-slate-200" : "bg-[var(--bg-primary)] border-[var(--border-secondary)]"}`}>
                  ...
                  <code className={`font-mono text-sm font-medium ${isLight ? "text-slate-800" : "text-slate-200"}`}>/sites</code>
                  <span className={`text-sm ml-2 ${isLight ? "text-slate-500" : "text-slate-500"}`}>Create a new WordPress site</span>
                </div>
                <div className="p-5">
                  {/* Request Body */}
                  <div className="mb-5">
                    <h4 className={`text-[11px] uppercase tracking-wider font-semibold mb-3 ${isLight ? "text-slate-500" : "text-slate-500"}`}>Request Body</h4>
                    <div className="space-y-2">
                      {[
    ...
    "admin_email": "admin@example.com"
              ...
              <div className={`rounded-xl border overflow-hidden ${isLight ? "bg-slate-50 border-slate-200" : "bg-[var(--gradient-card-to)] border-[var(--border-secondary)]"}`}>
                <div className={`px-5 py-4 border-b flex items-center gap-3 ${isLight ? "bg-slate-100 border-slate-200" : "bg-[var(--bg-primary)] border-[var(--border-secondary)]"}`}>
                  ...
                  <code className={`font-mono text-sm font-medium ${isLight ? "text-slate-800" : "text-slate-200"}`}>/sites/{"{site_id}"}</code>
                  <span className={`text-sm ml-2 ${isLight ? "text-slate-500" : "text-slate-500"}`}>Delete a site permanently</span>
                </div>
                <div className="p-5">
                  {/* Path Parameters */}
                  <div className="mb-5">
                    <h4 className={`text-[11px] uppercase tracking-wider font-semibold mb-3 ${isLight ? "text-slate-500" : "text-slate-500"}`}>Path Parameters</h4>
                    <div className="space-y-2">
                      <div className="flex items-start gap-4 py-2">
                        <div className="w-24 flex-shrink-0 flex items-center gap-1">
                          <code className={`font-mono text-sm ${isLight ? "text-slate-700" : "text-slate-300"}`}>site_id</code>
                          <span className="text-slate-500 text-xs">*</span>
                        </div>
                        <span className={`text-xs w-16 flex-shrink-0 ${isLight ? "text-slate-500" : "text-slate-600"}`}>string</span>
                        <span className={`text-sm ${isLight ? "text-slate-600" : "text-slate-400"}`}>Unique site identifier</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className={`rounded-xl p-4 border overflow-x-auto ${isLight ? "bg-slate-900 border-slate-800" : "bg-[var(--bg-primary)] border-[var(--border-secondary)]"}`}>
                      <pre className="text-sm font-mono">
                        ...
                        <span className="text-slate-300">&quot;https://api.limewp.com/v1/sites/site_abc123&quot;</span>{" "}
                        <span className="text-slate-600">\</span>{"\n"}
                        {"  "}<span className="text-slate-400">-H</span>{" "}
                        <span className="text-slate-300">&quot;Authorization: Bearer lwp_sk_your_api_key&quot;</span>
                      </pre>
