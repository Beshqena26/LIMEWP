...
export function CodeBlock({ title = "Terminal", children, className }: CodeBlockProps) {
  return (
    <div className={cn("relative bg-[#09090B] rounded-xl overflow-hidden", className)}>
      <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--bg-secondary)]">
        ...
        <button className="text-slate-500 hover:text-slate-300 transition-colors p-1 rounded hover:bg-[var(--bg-secondary)]">
