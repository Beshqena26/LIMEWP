    ...
    <div className={`relative overflow-hidden rounded-2xl border ${
      ...
      <div className="relative px-6 py-5 flex items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className={`font-semibold text-sm ${isLight ? "text-slate-800" : "text-slate-100"}`}>Need help choosing?</div>
            <p className={`text-xs ${isLight ? "text-slate-600" : "text-slate-500"}`}>Our team can help you find the perfect services for your needs.</p>
          </div>
        </div>
        <button
